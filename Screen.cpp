...
namespace textui {
    Screen::Screen(const std::string& screen_title, const std::vector<std::pair<char, std::string>> menu_options) {
        menu.set_title(screen_title);
        for (const std::pair<char, std::string>& option : menu_options) { 
